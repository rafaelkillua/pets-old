...
export default {
        ...
        return {
            ...
            rules: {
                ...
                senhaRules: [
                    ...
                    v =>
                        (v && v.length <= 20) ||
                        "Senha deve ter menos de 20 caracteres"
                ],
                repetirSenhaRules: [v => !!v || "Repetir senha é obrigatório"]
            },
            valid: true,
            showPassword: false,
            submitted: false
    ...
    methods: {
        confirmaSenha() {
            return this.form.repetirSenha === this.form.senha
                ? ""
        ...
        submit() {
            ...
            if (this.$refs.form.validate()) {
                this.$store
                    .dispatch("signUp", { email, senha, nome, telefone })
                    .catch(erro => {
